...
export const completeUpload = async (req, res) => {
  try {
    ...
    // Always process in background — diarization model takes longer than whisper-1
    // and synchronous processing hits Cloud Run's request timeout, dropping CORS headers.
